...
<section class="text-gray-600">
    <div class="container px-5 py-24 mx-auto">
        <div class="lg:w-2/4 w-full mx-auto overflow-auto">
                <h1 class="text-2xl font-medium title-font text-center mb-2 text-gray-900">Criar pessoa</h1>
            ...
            @method('post')
                <div class="flex flex-wrap flex-col justify-center items-center ">
                    ...
                    <div class="p-2 w-full">
                        <button type="submit" class="flex mt-2 mx-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Criar</button>
                    </div>
                </div>
            </form>
        </div>
